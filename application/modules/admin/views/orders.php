<div id="page-wrapper">
 ...
 -->
                           <li><a href="<?php echo base_url(). 'index.php/admin/allorders/pdf'?>">Download <?php echo $admin_subtitle?> to PDF</a></li>
                           <li><a href="<?php echo base_url(). 'index.php/admin/allorders/excel'?>">Download <?php echo $admin_subtitle?> to Excel</a></li>
                         </ul>
                       </div>
                     </div>
