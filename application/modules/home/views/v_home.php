        ...
        <div class="slider">
          ...
          <!-- Wrapper For Slides Starts -->
            <div class="carousel-inner">
              <div class="item billboard active">
                <img src="<?php echo base_url(). 'assets/images/image4.jpg'?>" alt="Slider" class="img-responsive" />
              </div>
              <div class="item billboard ">
                <img src="<?php echo base_url(). 'assets/images/bracelet.jpg'?>" alt="Slider" class="img-responsive" />
              </div>
			  <div class="item billboard ">
                <img src="<?php echo base_url(). 'assets/images/ring.jpg'?>" alt="Slider" class="img-responsive" />
              </div>
            </div>
