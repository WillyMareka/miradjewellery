               ...
               <div>
                ...
                <div class="control-label">Status
                  ...
                  <?php }?>
                        ...
                        <a href="<?php echo base_url(). 'index.php/stockmanager/products' ?>"><button class="view-back">Back</button></a>
                        <a href="<?php echo base_url().'index.php/stockmanager/viewproduct/'?><?php echo $data['prodid']?>"><button class="view-update">Update</button></a>
                  </div>
                </div>
                <!-- /.row -->
